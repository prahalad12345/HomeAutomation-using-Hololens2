...
#endif
//using SliderEventData = UnityEngine.Events.UnityEvent<MixedReality.Toolkit.UX.SliderEventData>;
using MixedReality.Toolkit.UX;

[AddComponentMenu("Scripts/FanUDPControl")]
public class FanUDPControl : MonoBehaviour
{
    [SerializeField]
    ...
    public void Connect(SliderEventData eventdata)
    {
        id = (int)(eventdata.NewValue);
        if (_useUWP)
        {
    ...
    {
        byte[] bytesToSend = converthexstringtobytearray(message[id]);
